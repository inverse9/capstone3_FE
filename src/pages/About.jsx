...
const About = ({ about }) => {
  return (
    <section ref={about} className="  px-20">
      ...
      suci di Bali yang terkenal menjadi tempat wisata, mulai dari lokasi, tata
      cara kunjungan, hingga etika yang perlu diperhatikan. Dengan begitu, Anda
      dapat menjelajahi tempat-tempat ini dengan rasa hormat dan pengalaman yang
      lebih bermakna.
      ...
      Kami percaya bahwa dengan informasi yang tepat, setiap kunjungan ke tempat
      suci dapat menjadi pengalaman spiritual dan budaya yang tak terlupakan.
    </section>
  );
};
